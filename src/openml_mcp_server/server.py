    ...
    async with httpx.AsyncClient(transport=transport) as client:
        try:
            ...
            try:
                ...
                message = error_data.get('error', {}).get('message', 'No specific error message provided.')
...
async def list_studies(filters: str) -> Union[Dict, str]:
    ...
    if not filters:
        return await _fetch_openml_data("/study/list/") # Need trailing slash for empty filters
